...
function LexImpact() {
    const page = "leximpact"
    const title = "LexImpact"
            ...
            <div className="content">
                ...
                <section>
                    ...
                    <ProjectAttribute
                        ...
                        simulation="produit une simulation sur une population"
                        imgperimetre="/static/icons/circle/perimetre.svg"
                        perimetre="utilise l'intégralité du système socio-fiscal"
