...
const Cookies = () => (
    <div className="content">
        ...
        <div id="iframe-container">
            <iframe
                style={{
                    backgroundColor: "#9a9a9a24", width: "70%", border: "none", padding: "1em 2em 0 2em",
                }}
        ...
        <p>
            <a href="https://matomo.org/">Matomo</a>
                {" "}
                - notre service de suivi - est configuré en conformité
                avec les règles de gestion de "Cookies" de la
